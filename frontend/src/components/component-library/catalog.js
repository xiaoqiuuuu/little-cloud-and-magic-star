    ...
    items: [
      {
        ...
        name: '反馈与弹窗',
        shortName: 'Alert / Empty / Modal',
        icon: '◌',
        status: 'ready',
        version: '0.2.0',
        description: '保存结果、风险提示、空数据以及需要聚焦处理的弹窗。',
        keywords: ['alert', 'empty', 'modal', '提示', '空状态', '弹窗', '反馈'],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        name: '复杂业务组件',
        shortName: 'Table / Form / Upload',
        icon: '▦',
        status: 'planned',
        description: '先统一主题 Token，再按真实业务差异封装复杂组件。',
        keywords: ['table', 'upload', 'form', '复杂组件'],
      },
    ],
  },
];
